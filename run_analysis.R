 ...
 xtrain <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/train/X_train.txt",header = FALSE)
 ytrain <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/train/y_train.txt",header = FALSE)
 
 #Reading the activity data
 activity <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/activity_labels.txt", header = FALSE)
 
 #Reading the test data
 xtest <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/test/X_test.txt", header = FALSE)
 ytest <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/test/y_test.txt", header = FALSE)
 
 #Reading the features data
 features <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/features.txt", header = FALSE)
 
 #Reading the subtrain data
 subtrain <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/train/subject_train.txt",header = FALSE)
 subtrain <- subtrain %>% rename(subjectID = V1)
 
 #Reading the subtest data
 subtest <- read.table("C:/Users/shant/OneDrive/Desktop/testing/UCI HAR Dataset/test/subject_test.txt", header = FALSE)
 subtest <- subtest %>% rename(subjectID = V1)
 
 #column names to train and test set
 features <- features[,2]
 featrasp <- t(features)
 ...
 #now we merge the above data frame with the activity
